export declare enum StockInterval {
    min1 = "1min",
    min5 = "5min",
    min15 = "15min",
    min30 = "30min",
...
export declare type StockSymbol = string;
export declare enum StockOutputSize {
    Compact = "Compact",
    Full = "Full"
}
export declare enum StockDataType {
    Json = "json",
    Csv = "csv"
}
export declare enum SerializedKey {
    "Aroon Down" = "down",
    "Aroon Up" = "up",
    "Meta Data" = "meta",
